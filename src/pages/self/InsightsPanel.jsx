    ...
    >
      <div className="rounded-2xl border border-marble/20 bg-marble/5 p-8">
        <div className="flex">
          ...
          <div className="flex-1 relative">
            <svg viewBox="0 0 400 240" className="w-full h-72" preserveAspectRatio="none">
              ...
              <path d="M0,150 C40,150 60,60 110,60 C150,60 170,110 220,110 C260,110 280,160 400,170 L400,210 C280,200 260,150 220,150 C170,150 150,100 110,100 C60,100 40,190 0,190 Z" fill="rgba(213,226,74,0.07)" />
              ...
              <path d="M0,170 C40,170 60,80 110,80 C150,80 170,130 220,130 C260,130 280,180 400,190" fill="none" stroke={URG} strokeWidth="2.5" />
              <line x1="110" y1="80" x2="110" y2="20" stroke={URG} strokeWidth="1.5" strokeDasharray="4 4" opacity="0.6" />
        ...
        <div className="mt-6 pt-5 border-t border-marble/20 flex flex-wrap items-center gap-6">
          <span className="flex items-center gap-2 text-[10px] tracking-wider text-urgent"><span className="w-4 h-1 rounded bg-urgent"/>CAPACITY</span>
          ...
          <span className="flex items-center gap-2 text-[10px] tracking-wider text-storm/50"><span className="w-4 h-2 rounded bg-marble/15 border border-marble/30"/>CONFIDENCE</span>
        </div>
      </div>
    </PanelShell>
  );
